...
public class ObInimigo3 extends ObInimigo {

    public ObInimigo3(int x, int y, int velX, int velY, int id, int vida, Processador proces, int largura, int altura) {
        super(x, y, velX, velY, id, vida, proces, largura, altura);
    }

    @Override
    public void render(Graphics g) {
        Color corInimigo = new Color(4, 7, 178, 255);
