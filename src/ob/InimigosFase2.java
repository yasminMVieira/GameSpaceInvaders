...
import java.awt.Rectangle;
    ...
    public class InimigosFase2 extends ObObjeto {

        public InimigosFase2() {
        }

        public InimigosFase2(int x, int y, int velX, int velY, int id, int vida, Processador proces, int largura, int altura) {
        ...
        */
        ...
        public void atirar() {
            ObProjetil proj = new ObProjetil(x, y + 50, 0, 5, 4, 2, proces, largura, altura);
